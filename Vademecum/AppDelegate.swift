...
// //  Vademecum
// //
// //  Created by Sebastian Fiedlschuster on 12.08.16.
// //  Copyright © 2016 Wingolf. All rights reserved.
// //
//
// import UIKit
// import CoreData
...
//         // The directory the application uses to store the Core Data store file. This code uses a directory named "org.wingolf.Vademecum" in the application's documents Application Support directory.
...
//         let modelURL = NSBundle.mainBundle().URLForResource("Vademecum", withExtension: "momd")!
